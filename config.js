System.config({
  ...
  map: {
    ...
    "pipeline-validate-js": "npm:pipeline-validate-js@1.0.0-rc",
    ...
    "npm:eslint@2.6.0": {
      ...
      "debug": "npm:debug@2.2.0",
      "doctrine": "npm:doctrine@1.2.1",
      "es6-map": "npm:es6-map@0.1.3",
      "escope": "npm:escope@3.6.0",
      "espree": "npm:espree@3.1.3",
      "estraverse": "npm:estraverse@4.2.0",
      "esutils": "npm:esutils@2.0.2",
      "events": "github:jspm/nodelibs-events@0.1.1",
      ...
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "glob": "npm:glob@7.0.3",
      "globals": "npm:globals@9.3.0",
      "ignore": "npm:ignore@3.0.14",
    ...
    "npm:inquirer@0.12.0": {
      "ansi-escapes": "npm:ansi-escapes@1.3.0",
      "ansi-regex": "npm:ansi-regex@2.0.0",
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "chalk": "npm:chalk@1.1.3",
    ...
    "npm:pipeline-validate-js@1.0.0-rc": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "gulp": "npm:gulp@3.9.0",
      "gulp-eslint": "npm:gulp-eslint@2.0.0",
      "lazypipe": "npm:lazypipe@1.0.1",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "pipeline-handyman": "npm:pipeline-handyman@1.0.0",
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
